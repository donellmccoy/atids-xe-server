...
namespace TheFund.AtidsXe.Data.Configuration
{
    public class NameSearchListItemConfiguration : IEntityTypeConfiguration<NameSearchListItem>
    {
        public void Configure(EntityTypeBuilder<NameSearchListItem> entity)
        {
            ...
            entity.Property(e => e.NameSearchListItemId).HasColumnName("NAME_SEARCH_LIST_ITEM_ID");

            entity.Property(e => e.ChainOfTitleId).HasColumnName("CHAIN_OF_TITLE_ID");

            entity.Property(e => e.LegalEntityNameId).HasColumnName("LEGAL_ENTITY_NAME_ID");

            entity.Property(e => e.NameSearchStatusCodeId).HasColumnName("NAME_SEARCH_STATUS_CODE_ID");

            entity.Property(e => e.ReferenceTitleEventId).HasColumnName("REFERENCE_TITLE_EVENT_ID");
